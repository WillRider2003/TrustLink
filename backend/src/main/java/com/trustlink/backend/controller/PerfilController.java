...
public class PerfilController {
    ...
    public String actualizarNotificaciones(@RequestParam(required = false) Boolean notificacionesEnApp,
                                            @RequestParam(required = false) Boolean notificacionesPorCorreo,
                                            @AuthenticationPrincipal UsuarioPrincipal principal) {
        Usuario actualizado = perfilService.actualizarPreferenciasNotificacion(principal.getId(),
                notificacionesEnApp != null, notificacionesPorCorreo != null);
        refrescarSesion(actualizado);
        return "redirect:/perfil?notifActualizadas=true";
    }
