...
function tlRenderChatbotWidget() {
  ...
  if (!mount) return;
  mount.innerHTML = `
    <button class="chatbot-fab" id="chatbotFab" aria-label="Abrir chatbot">
      <span class="chatbot-fab-inner">
        <img src="img/trusti-fab.png" alt="Trusti">
      </span>
    </button>
    <div class="chatbot-panel" id="chatbotPanel">
      <div class="chatbot-header">
        <div class="chatbot-header-icon" style="background:#fff; padding:0; overflow:hidden;">
          <img src="img/trusti-fab.png" alt="Trusti" style="width:100%; height:100%; object-fit:cover; border-radius:50%;">
        </div>
        <div class="chatbot-header-text">
          <div class="chatbot-header-title">Trusti Chatbot</div>
      ...
      <div class="chatbot-messages" id="chatbotMessages">
        <div class="chat-msg bot">Hola, soy Trusti 👋 Pregúntame sobre el escrow, el código de confirmación, el crédito o cómo reportar una incidencia.</div>
        <img src="img/trusti-avatar.png" alt="Trusti saludando" id="chatbotSaludoImg" style="width:120px; display:block; margin:6px auto 10px;">
      </div>
